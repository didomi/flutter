...
class EntitiesHelper {
  ...
  static List<Purpose> toPurposes(List<dynamic> rawList) =>
      rawList.map((e) => Purpose.fromJson(e)).toList();

  /// Convert a list of dictionaries into a list of vendors.
  static List<Vendor> toVendors(List<dynamic> rawList) =>
      rawList.map((e) => Vendor.fromJson(e)).toList();
  ...
  static Purposes? toPurposesStatus(dynamic json) =>
      json != null ? Purposes.fromJson(json) : null;

  /// Convert json to vendors status info, or null
  static Vendors? toVendorsStatus(dynamic json) =>
      json != null ? Vendors.fromJson(json) : null;
}
