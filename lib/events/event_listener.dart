...
class EventListener {
  ...
  dynamic Function(String purposeId) onPreferencesClickPurposeAgree =
      (purposeId) {};

  /// User switched a purpose status to Disagree
  dynamic Function(String purposeId) onPreferencesClickPurposeDisagree =
      (purposeId) {};
  ...
  dynamic Function(String categoryId) onPreferencesClickCategoryDisagree =
      (categoryId) {};
  ...
  dynamic Function(String organizationUserId) onSyncDone =
      (organizationUserId) {};
