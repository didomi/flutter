...
import 'package:didomi_sdk_example/testapps/sample_for_user_consent_for_vendor_tests.dart' as app;
...
void main() {
  ...
  group("User Consent for Vendor", () {
    ...
    testWidgets("Click get user consent for vendor '738' without initialization", (WidgetTester tester) async {
      // Start app
      app.main();
    ...
    testWidgets("Click get user consent for vendor '738' with initialization", (WidgetTester tester) async {
      // Start app
      app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets("Click get user consent for vendor '738' with initialization after agree", (WidgetTester tester) async {
      // Start app
      app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets("Click get user consent for vendor '738' with initialization after disagree then reset", (WidgetTester tester) async {
      // Start app
      app.main();
      await tester.pumpAndSettle();
