...
import 'package:didomi_sdk_example/test/sample_for_user_consent_for_vendor_and_required_purposes_tests.dart' as userConsentForVendorAndRequiredPurpose;
...
void main() {
  ...
  group("User Consent for Vendor and Required Purposes", () {
    ...
    testWidgets("Click get user consent for vendor '1' and required purpose without initialization", (WidgetTester tester) async {
      // Start userConsentForVendorAndRequiredPurpose
      userConsentForVendorAndRequiredPurpose.main();
