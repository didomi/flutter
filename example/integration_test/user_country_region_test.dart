...
void main() {
  ...
  group("User country and region", () {

    testWidgets("Get user country/region code without initialization", (WidgetTester tester) async {
      // Start app
      app.main();
      ...
      try {
        await DidomiSdk.userCountryCode;
    ...
    testWidgets("Get user country/region code with initialization", (WidgetTester tester) async {
      // Start app
      app.main();
      await tester.pumpAndSettle();
